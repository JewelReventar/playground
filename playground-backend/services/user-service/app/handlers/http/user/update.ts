...
// INTERFACES
import { UpdateUserInterface } from '../../_interfaces/user'
import {
...
// SCHEMA RULES
import { updateUserSchema as schema } from '../_rules/schemas/user'
import schemaValidator from '../_rules/schemas/validate'
// CONTROLLERS
import UserController from '../../../controllers/UserController'

const execute = async (
  event: HttpsLambdaInterface<UpdateUserInterface>,
  _context: Context,
  ...
  try {
    ...
    const response = await controller.update(event.request)
...
export const handler = middy(execute)
  ...
  .use(schemaValidator<UpdateUserInterface>(schema))
